...
def learn(sst_dat, precip_dat, norm, file_name=None, sst_var='sst', precip_var='tp', train_pct=0.8, batch=32, epochs=100, latent_dim=1, verbose=True):
    import matplotlib.backends.backend_pdf
    ...
    if file_name:
        ...
        # Latent plot as its own page
        fig_latent = plot_latent(latent_series, "Shared Latent Index from MIMO-AE")
